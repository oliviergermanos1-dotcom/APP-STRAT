...
// Browser build: PptxGenJS is loaded via <script> tag (window.PptxGenJS).
// BLOCK_SEQUENCE and dataAdapter are defined inline below.
...
// dsmData injected at runtime via window.__DSM_DATA__
...
// miningData injected at runtime via window.__MINING_DATA__
...
// Browser build: expose on window for app.js
